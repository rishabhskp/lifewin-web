                    ...
                    <tr>
                      <td class="wrapper last">
                        ...
                        <table class="twelve columns">
                          <tr>
                            <td class="twelve columns" style = "text-align:center;">
                              <img src="logo.png" style = "text-align:center;margin-left:-67px;left:50%;position:relative;">
                            </td>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h1>Dear '.$name.',</h1>
                            <p class="lead">A request was made to reset the password for your LifeWin account.</p>
                            <p>You can reset your password by clicking on the link below. If
                      ...
                      <table class="six columns">
                        <tr>
                          <td class="left-text-pad">
                            ...
                            <table class="tiny-button reddit">
                              <tr>
                                <td>
                                  <a href="#">Reddit</a>
                                </td>
                      ...
                      <table class="six columns">
                        <tr>
                          <td class="last right-text-pad">
                            <h5>Contact Info:</h5>
                            <p>Email: <a href="mailto:hseldon@trantor.com">contact@lifewin.com</a></p>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
